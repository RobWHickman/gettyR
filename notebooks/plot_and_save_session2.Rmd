...
```{r}
plot_and_save_cluster_data <- function(specific_cell, trace_data = trace_data, spike_data = spike_data$sorted_spikes) {
  trace_plot <- gettyR::plot_cell_trace(trace_data = trace_data, specific_cell = specific_cell)
  isi_histogram <- gettyR::plot_isi_histogram(spikes = spike_data, specific_cell = specific_cell)
